...
CONFIG_TLW_ADAPTIVITY_EN = disable
CONFIG_TLW_ADAPTIVITY_MODE = normal
...
CONFIG_TLW_SDIO_PM_KEEP_POWER = y
...
_HAL_INTFS_FILES +=	hal/$(TTL902X)/$(TTL902X)_hal_init.o \
			...
			hal/$(TTL902X)/$(HCI_NAME)/ttl$(MODULE_NAME)_led.o \
			hal/$(TTL902X)/$(HCI_NAME)/ttl$(MODULE_NAME)_xmit.o \
			hal/$(TTL902X)/$(HCI_NAME)/ttl$(MODULE_NAME)_recv.o
...
_OUTSRC_FILES += hal/phydm/$(TTL902X)/halhwimg9083e_mac.o\
		...
		hal/phydm/$(TTL902X)/phydm_ttl9083e.o
...
_OUTSRC_FILES += hal/phydm/ttl8821a/halhwimg8821a_fw.o\
		...
		hal/phydm/ttl8821a/halhwimg8821a_rf.o\
		hal/phydm/ttl8812a/halphyrf_8812a_ce.o\
		hal/phydm/ttl8821a/halphyrf_8821a_ce.o\
		hal/phydm/ttl8821a/phydm_regconfig8821a.o\
		hal/phydm/ttl8821a/phydm_ttl8821a.o\
		hal/phydm/ttl8821a/phydm_iqk_8821a_ce.o
endif
...
_OUTSRC_FILES += hal/phydm/$(TTL902X)/halhwimg8723b_bb.o\
								...
								hal/phydm/$(TTL902X)/phydm_ttl8723b.o
...
_OUTSRC_FILES += hal/phydm/$(TTL902X)/halhwimg8814a_bb.o\
								...
								hal/phydm/$(TTL902X)/phydm_ttl8814a.o
...
_OUTSRC_FILES += hal/phydm/$(TTL902X)/halhwimg9083f_bb.o\
								...
								hal/phydm/$(TTL902X)/phydm_ttl9083f.o
...
ifeq ($(CONFIG_TLW_ADAPTIVITY_EN), disable)
EXTRA_CFLAGS += -DCONFIG_TLW_ADAPTIVITY_EN=0
else ifeq ($(CONFIG_TLW_ADAPTIVITY_EN), enable)
EXTRA_CFLAGS += -DCONFIG_TLW_ADAPTIVITY_EN=1
endif

ifeq ($(CONFIG_TLW_ADAPTIVITY_MODE), normal)
EXTRA_CFLAGS += -DCONFIG_TLW_ADAPTIVITY_MODE=0
else ifeq ($(CONFIG_TLW_ADAPTIVITY_MODE), carrier_sense)
EXTRA_CFLAGS += -DCONFIG_TLW_ADAPTIVITY_MODE=1
endif
...
ifeq ($(CONFIG_SDIO_HCI), y)
EXTRA_CFLAGS += -DCONFIG_TLW_SDIO_PM_KEEP_POWER
endif
endif
...
ifeq ($(CONFIG_TLW_SDIO_PM_KEEP_POWER), y)
ifeq ($(CONFIG_SDIO_HCI), y)
EXTRA_CFLAGS += -DCONFIG_TLW_SDIO_PM_KEEP_POWER
endif
endif
...
EXTRA_CFLAGS += -DCONFIG_LITTLE_ENDIAN
#EXTRA_CFLAGS += -DTLW_ENABLE_WIFI_CONTROL_FUNC
# default setting for Android 4.1, 4.2, 4.3, 4.4
EXTRA_CFLAGS += -DCONFIG_PLATFORM_ACTIONS_ATM705X
EXTRA_CFLAGS += -DCONFIG_CONCURRENT_MODE
EXTRA_CFLAGS += -DCONFIG_IOCTL_CFG80211 -DTLW_USE_CFG80211_STA_EVENT
...
# Enable this for Android 5.0
EXTRA_CFLAGS += -DCONFIG_RADIO_WORK
EXTRA_CFLAGS += -DTLW_VENDOR_EXT_SUPPORT
ARCH := arm
...
EXTRA_CFLAGS += -DCONFIG_P2P_IPS -DTLW_USE_CFG80211_STA_EVENT
EXTRA_CFLAGS += -DCONFIG_RADIO_WORK
#ARCH := arm
ARCH := arm64
...
EXTRA_CFLAGS += -DTLW_ENABLE_WIFI_CONTROL_FUNC
EXTRA_CFLAGS += -DTLW_SUPPORT_PLATFORM_SHUTDOWN
