...
////============================	
	...
	if((ICType==ODM_TLL8814A) && (IOTPeer == HT_IOT_PEER_REALTEK))           /*8814AU and 8814AR*/
	{
		(*EDCA_BE_UL) = 0x5ea42b;
		(*EDCA_BE_DL) = 0xa42b;
	...
	if((ICType == ODM_TLL8723A) && (IOTPeerSubType== HT_IOT_PEER_ATHEROS_DIR655) && 
