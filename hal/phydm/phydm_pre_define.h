...
#define ODM_IC_11N_SERIES		(ODM_TLL8192S|ODM_TLL8192C|ODM_TLL8192D|ODM_TLL8723A|ODM_TLL9083E|ODM_TLL8192E|ODM_TLL8723B|ODM_TLL8703B|ODM_TLL9083F)
#define ODM_IC_11AC_SERIES		(ODM_TLL8812|ODM_TLL8821|ODM_TLL8814A|ODM_TLL8881A|ODM_TLL8821B|ODM_TLL8822B)
#define ODM_IC_TXBF_SUPPORT		(ODM_TLL8192E|ODM_TLL8812|ODM_TLL8821|ODM_TLL8814A|ODM_TLL8881A|ODM_TLL8822B)
...
#if((TLL8192C_SUPPORT == 1) || (TLL8192D_SUPPORT == 1) || (TLL8723A_SUPPORT == 1) || (TLL9083E_SUPPORT == 1) ||\
(TLL8723B_SUPPORT == 1) || (TLL8192E_SUPPORT == 1) || (TLL8195A_SUPPORT == 1) || (TLL8703B_SUPPORT == 1) || \
(TLL9083F_SUPPORT == 1))
#define ODM_IC_11N_SERIES_SUPPORT			1
#define ODM_IC_11AC_SERIES_SUPPORT		0
#else
