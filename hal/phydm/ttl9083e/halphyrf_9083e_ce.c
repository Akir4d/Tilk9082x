	...
	)
{
	...
	*TemperatureUP_B = (pu1Byte)DeltaSwingTableIdx_2GA_P_9083E;
	*TemperatureDOWN_B = (pu1Byte)DeltaSwingTableIdx_2GA_N_9083E;		
}
...
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		PathAOK = phy_PathA_IQK_9083E(pAdapter, is2T);
#else
		PathAOK = phy_PathA_IQK_9083E(pDM_Odm, is2T);
#endif
//		if(PathAOK == 0x03){
		if(PathAOK == 0x01){
