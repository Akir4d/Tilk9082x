...
#endif
//
// <Roger_Notes> For TLL8723 WiFi/BT/GPS multi-function configuration. 2010.10.06.
//
...
//
// <Roger_Notes> For TLL8723 WiFi PDn/GPIO polarity control configuration. 2010.10.08.
//
...
// For TLL8723 regulator mode. by tynli. 2011.01.14.
...
#if defined(CONFIG_TLL8723B) || defined(CONFIG_TLL8703B) || defined(CONFIG_TLL9083F)
	#ifndef CONFIG_PCI_HCI	// mutual exclusive with PCI -- so they're SDIO and GSPI 
	// Interrupt relatd register information.
	u32			SysIntrStatus;
	u32			SysIntrMask;
	#endif
#endif /*endif CONFIG_TLL8723B	*/
...
#define tlw_get_hw_init_completed(adapter)		(GET_HAL_DATA(adapter)->hw_init_completed)
#define tlw_is_hw_init_completed(adapter)		(GET_HAL_DATA(adapter)->hw_init_completed == _TRUE)
#endif
...
#define tlw_get_acs_channel(padapter)				(GET_HAL_DATA(padapter)->acs.ch)
#define tlw_set_acs_channel(padapter, survey_ch)	(GET_HAL_DATA(padapter)->acs.ch = survey_ch)
#endif /*CONFIG_AUTO_CHNL_SEL_NHM*/
