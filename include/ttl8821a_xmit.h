...
s32 ttl8821au_init_xmit_priv(PADAPTER padapter);
void ttl8821au_free_xmit_priv(PADAPTER padapter);
s32 ttl8821au_hal_xmit(PADAPTER padapter, struct xmit_frame *pxmitframe);
s32 ttl8821au_mgnt_xmit(PADAPTER padapter, struct xmit_frame *pmgntframe);
s32 ttl8821au_hal_xmitframe_enqueue(PADAPTER padapter, struct xmit_frame *pxmitframe);
s32 ttl8821au_xmit_buf_handler(PADAPTER padapter);
void ttl8821au_xmit_tasklet(void *priv);
s32 ttl8821au_xmitframe_complete(PADAPTER padapter, struct xmit_priv *pxmitpriv, struct xmit_buf *pxmitbuf);
...
void ttl8821e_xmit_tasklet(void *priv);
